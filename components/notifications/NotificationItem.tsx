...
export function NotificationItem({
  ...
  const getNotificationLink = () => {
    ...
    const entityMap: Record<string, string> = {
      purchase_request: `/procurement/pr/${notification.entity_id}`,
      purchase_order: `/procurement/po/${notification.entity_id}`,
      procurement_proposal: `/procurement/planning/${notification.entity_id}`,
    };
