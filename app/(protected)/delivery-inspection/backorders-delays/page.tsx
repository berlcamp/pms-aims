  ...
  return (
    <div>
      <div className="app__title">
        <h1 className="app__title_text">Backorders / Delays</h1>
      ...
      <div className="app__content">
        {loading ? (
          ...
          <div className="app__empty_state">
            ...
            <p className="app__empty_state_title">No backorders or delays found</p>
            <p className="app__empty_state_description">
              Get started by creating a new backorder or delay record
            </p>
          </div>
        ) : (
            ...
            <div className="app__table_wrapper">
              <table className="app__table">
                <thead className="app__table_thead">
                  <tr>
                    <th className="app__table_th">Order Number</th>
