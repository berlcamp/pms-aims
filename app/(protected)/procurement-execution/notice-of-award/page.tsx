  ...
  return (
    <div>
      <div className="app__title">
        <h1 className="app__title_text">Notice of Award</h1>
      ...
      <div className="app__content">
        {loading ? (
          ...
          <div className="app__empty_state">
            ...
            <p className="app__empty_state_title">No notices of award found</p>
            <p className="app__empty_state_description">
              Get started by creating a new notice of award
            </p>
          </div>
        ) : (
            ...
            <div className="app__table_wrapper">
              <table className="app__table">
                <thead className="app__table_thead">
                  <tr>
                    <th className="app__table_th">NOA Number</th>
